...
export function GlobalPresence() {
  ...
  return (
    <section ref={sectionRef} className="max-w-7xl mx-auto px-10 py-32 flex flex-col items-center text-center">
      <div className="space-y-6 mb-20">
        <div className="w-16 h-16 bg-zinc-50 rounded-full flex items-center justify-center border border-zinc-100 mx-auto mb-8 animate-pulse">
          <Globe2 className="w-8 h-8 text-black" />
        </div>
        <h2 className="text-5xl font-semibold tracking-tight">{LANDING_DATA.global.title}</h2>
        <p className="text-zinc-500 text-lg font-light">{LANDING_DATA.global.subtitle}</p>
      </div>

      <div className="flex flex-wrap justify-center gap-x-20 gap-y-10">
        {LANDING_DATA.global.cities.map((city) => (
          <div key={city.name} className="city-item space-y-2 text-left opacity-0">
            <span className="text-[10px] font-bold text-zinc-300 uppercase tracking-widest">{city.region}</span>
            <div className="text-3xl font-semibold tracking-tight group cursor-pointer">
...
export function PremiumFooter() {
  ...
  return (
    <footer ref={footerRef} className="bg-[#fafafa] border-t border-zinc-100 pt-24 pb-12">
      <div className="max-w-7xl mx-auto px-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-16 mb-24">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <p className="text-zinc-500 font-light leading-relaxed max-w-sm text-lg">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between pt-12 border-t border-zinc-200/60 gap-8">
